 ...
 *
 */
@Entity(name="t_noticeInstructionsLog")
public class NoticeInstructionsLog implements Serializable {
	...
	private String instructionsVariety;	//指令种类   1为开户指令  2 为审批划款指令  3为解除资金监管指令  4为撤销购买合同的指令  5 开发账户变更的指令  6购房入账通知指令  
	
	private String houseNo;	//地幢号相当于buildingInfo中的buildingId
