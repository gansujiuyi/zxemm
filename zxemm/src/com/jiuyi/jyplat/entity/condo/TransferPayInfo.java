 ...
 *
 */
@Entity(name = "t_transferPayInfo")
public class TransferPayInfo implements Serializable{
	...
	private String auditTransferMoneyNo;//订单编号
	...
	private String payTranchannel;//支付渠道
	...
	public String getPayTranchannel() {
		return payTranchannel;
	}

	public void setPayTranchannel(String payTranchannel) {
		this.payTranchannel = payTranchannel;
	}
	...
	public String getAuditTransferMoneyNo() {
		return auditTransferMoneyNo;
	}

	public void setAuditTransferMoneyNo(String auditTransferMoneyNo) {
		this.auditTransferMoneyNo = auditTransferMoneyNo;
	}
