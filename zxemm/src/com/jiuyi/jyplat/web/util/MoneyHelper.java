...
public class MoneyHelper {
	...
	public static void main(String[] args) {
		BigDecimal aa = new BigDecimal(1234567890.11);
		System.out.println(conv(aa));
	}
	
	public static String conv(Double money){
		return cleanZero(splitNum(roundString(Double.toString(money))));
	}
	
	public static String conv(BigDecimal money){
		return cleanZero(splitNum(roundString(money.toString())));
	}
