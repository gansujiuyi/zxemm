			...
			<form id=PageForm name=PageForm method=post action="">
				<div id="itemList">
					<div class="loc">
						...
						<a href="capitalManage/queryUnfreezeCapitalInfoAll.do" >资金监管资金解冻</a> &raquo; 
					...
					<div style="padding: 10px; padding-left: 10px;">
						<div style="width: 250px; float: left;">
							 <a href="javascript:javascript:history.go(-1);">
								...
								<a href="javascript:modifyState('${orderinfo.orderId}','0000')" class="a-bluebtn">
									<img src="<%=path%>/images/template/b_enable.png" alt="IMG" />解冻
								</a><!-- 如果是冻结状态就显示解冻 -->
