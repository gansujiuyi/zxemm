			...
			<form id=PageForm name=PageForm method=post action="">
				<div id="itemList">
					<div class="loc">
						...
						<a href="javascript:gotoListHome()" ><span class="last">资金监管终止流程查询</span></a> 
					</div>
					<!-- 全/反选 -->
					<div class="chooseCase">
						...
						<div style="float: left" class="search">
							<table width="100%" border="0">
								...
								<td width="5%" >房产证号：</td>
									<td >
	                                	<input id="" name="orderinfo.sstr2" value="${orderinfo.sstr2}" type="text" class="txt-150" />						
									</td>
									<td width="5%" >监管流水号：</td>
									...
									<select name="orderinfo.orderStatus">
										...
										<a href="javascript:submitForm('endFlowManage/queryEndCapitalInfoAll.do')">
...
<!-- <form id="capitalByIdInfo" action="capitalManage/queryCapitalByIdInfo.do" method="post">
 ...
 <form id="capitalByIdInfo" action="capitalManage/queryEndFlowByIdInfo.do" method="post">
	<input type="hidden" id="orderId" name="orderinfo.orderId"/>
</form> 
		</div>
	</body>
