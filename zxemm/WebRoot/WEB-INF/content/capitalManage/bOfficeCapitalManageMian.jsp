			...
			<form id=PageForm name=PageForm method=post action="">
				<div id="itemList">
					<div class="loc">
						...
						<span>客服报表管理</span> &raquo;
						<span>客服报表查询</span> &raquo; 
						<a href="javascript:gotoListHome()" ><span class="last">资金监管信息查询</span></a> 
					</div>
					<!-- 全/反选 -->
						...
						<div style="float: left" class="search">
							<table width="100%" border="0">
								<tr>
									...
									<td width="5%" >监管流水号：</td>
									<td width="5%" ><input id="" name="orderinfo.orderId" value="${orderinfo.orderId}" type="text" class="txt-150" /></td>		
				              	</tr>
				              	<tr>
					                <td width="5%" >房源编号：</td>
									<td >
									...
									<select name="orderinfo.orderStatus">
										...
										<a href="javascript:submitForm('capitalManage/queryBofficeCapitalInfoAll.do')">
									...
									<tr >
										...
										<td class="thStyle">
											<c:choose>
												...
												<c:when test="${capital.orderStatus eq '1020' && capital.isRefunded eq '0000'}">
													等待支付
												</c:when>
...
<form id="capitalByIdInfo" action="capitalManage/queryBofficeCapitalByIdInfo.do" method="post">
