			...
			<form id=PageForm name=PageForm  method=post>
				...
				<div class="tab_cntr">
					<table class="editorTb" style="" id="tbBase"  name="editorTab">
						<tr>
							<td class="hd" colspan="2">
								新增关键字（<font color="red">* 为必填项</font>）
							</td>
						</tr>
						<tr>
							<td class="titl">
							...
							<td>
								<input id="key" name="keyword.key" type="text" class="txt-150" maxlength="10" />
								<font color="red">&nbsp;*</font>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input id="value" name="keyword.value" type="text" class="txt-150" maxlength="30"/>
							</td>
						</tr>
						<tr>
							<td class="titl">
							...
							<td>
								<textarea id="description" name="keyword.description" rows="" cols=""  class="txt-150"></textarea>
							</td>
						</tr>
					</table>
					...
					<div style="padding: 10px; padding-left: 10px;">
						...
						<input type="button" name="btnSave"  onclick="submitForm('keyword/saveKeyWord.do','add')" id="btnSave" class="save" />
