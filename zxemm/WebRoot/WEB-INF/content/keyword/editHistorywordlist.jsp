				...
				<div class="tab_cntr">
					<table class="editorTb" style="" id="tbBase"  name="editorTab">
						...
						<tr>
							...
							<td >
								<input id="serword" name="historyword.SERCHWORD" type="text" class="txt-150" />
								<font color="red">&nbsp;*</font>
							</td>
						</tr>												
							<tr>
							...
							<td >
								<select name="historyword.WORDSTATE" id="wordstatus" class="sel-156">
									<option value="1" <c:if test="${'1' eq goodsInfo.heat}">selected</c:if>>正常</option>
									<option value="2" <c:if test="${'2' eq goodsInfo.heat}">selected</c:if>>已删除 </option>
								</select>
								<font color="red"> *</font>
							</td>
						</tr>
					...
					<div style="padding: 10px; padding-left: 10px;">
						...
						<input type="button" name="btnSave"  onclick="submitForm('historyWord/saveHistoryWord.do','add')" id="btnSave" class="save" />
