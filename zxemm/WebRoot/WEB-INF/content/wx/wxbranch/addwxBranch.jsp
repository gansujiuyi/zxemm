				...
				<div class="tab_cntr">
					...
					<table class="editorTb" style="" id="tbBase" name="editorTab">
						<tr>
							<td class="hd" colspan="2">
								新增网点信息（<font color="red">* 为必填项</font>）
							</td>
						</tr>
						<tr>
							<td class="titl">
							...
							<td>
								<select id="type" name="wxbranch.type" class="sel">
					        		...
					        		<c:forEach var="type" items="${typesysEnum.sysEnumItems}">
										...
										<c:if test="${type.status!='1'}">
											<option value="${type.fieldValue }" <c:if test="${fn:trim(wxbranch.type) == fn:trim(type.fieldValue) }">selected</c:if> style="background-color: orange;" >${type.displayValue }</option>
										</c:if>
									</c:forEach>
								</select>
								<font color="red"> *</font>
						...
						<tr >
							...
							<td>
								<input id="name" name="wxbranch.name"  class="txt-300" /><font color="red"> *</font>
							</td>
						</tr>
						<tr >
							<td class="titl">
							...
							<td>
								<textarea id="address" name="wxbranch.address" rows="5" cols="20" class="txt txt1"></textarea><font color="red"> *</font>
							</td>
						</tr>
						<tr >
							<td class="titl">
						...
						<tr >
							...
							<td>
								<input id="mobilePhone" name="wxbranch.mobilePhone"  class="txt-150" />
							</td>
						</tr>
						<tr id = "branchorgno">
							<td class="titl">
							...
							<td>
								<input id="orgno" name="wxbranch.orgno" class="txt-150" maxlength="5" onkeyup="value=this.value.replace(/\D+/g,'')"/><font color="red"> *</font>
							</td>
						</tr>
						<tr >
							<td class="titl">
							...
							<td>
								<input id="locationY" name="wxbranch.locationY"  type="text"  class="txt-150" />&nbsp;&nbsp;-&nbsp;&nbsp;<input id="locationX" name="wxbranch.locationX"  class="txt-150" type="text" /><font color="red"> *</font>
							</td>
						</tr>
						<tr >
							<td class="titl">
					...
					<div style="padding: 10px; padding-left: 10px;">
						...
						<input type="button" name="btnSave" value=""
							onclick="submitForm('<%=path %>/wxBranch/addWXBranch.do','add')"
