				...
				<div class="tab_cntr">
					...
					<table class="editorTb" style="" id="tbBase" name="editorTab">
						<tr>
							<td class="hd" colspan="2">
								新建系统角色（<font color="red">* 为必填项</font>）
							</td>
						</tr>
						<tr>
							<td class="titl">
							...
							<td>
								<input id="roleName" name="role.roleName" type="text" maxlength="20" class="txt-150"/>
									<font color="red">&nbsp;*</font>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<textarea id="description" name="role.description" rows="2" cols="20" class="txt-300"></textarea>
							</td>
						</tr>
					</table>
					...
					<div class="btn-wz">
						...
						<input type="button" name="btnSave" value=""
							onclick="submitForm('acegi/saveAddedRole.do','add')"
