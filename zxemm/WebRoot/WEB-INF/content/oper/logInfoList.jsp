...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id=mainzone>
			<div id="body">
				<FORM id="PageForm" name="PageForm" method=post action="acegi/queryAllLog.do">
					<div id="itemList">
						<div class="loc">
						...
						<div class="chooseCase">
							...
							<div style="float: left" class="search">
								<table width="100%">
									<tr>
						                <td width="5%" align="right">操作员编号：</td>
										<td width="10%">
		                                	<input id="operNo" name="logInfo.operNo" value="${logInfo.operNo }" type="text" class="txt-150"/>
		                                </td>
										...
										<td >
											<INPUT id="startDate" class="Wdate" onClick="WdatePicker({maxDate:'%y-%M-%d',dateFmt:'yyyyMMdd'})" readOnly  size=16 name="logInfo.startDate" value="${logInfo.startDate }" style="width:120px;height:16px"/>
												-
											<INPUT id="endDate" class="Wdate" onClick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\');}',dateFmt:'yyyyMMdd'})" readOnly  size=16 name="logInfo.endDate" value="${logInfo.endDate }" style="width:120px;height:16px"/>
		                                </td>
		                            </tr>
		                            <tr>
						                <td width="5%" align="right">功能平台：</td>
										<td width="10%">
		                                	<select id="platform" name="logInfo.platform" onchange="queryModule()" class="sel-156">
										...
										<td width="10%" align="right">功能模块：</td>
										<td width="10%" colspan="3">
											<select id="module" name="logInfo.module" class="sel-156">
											...
											<a href="javascript:submitForm('acegi/queryAllLog.do','search')">
