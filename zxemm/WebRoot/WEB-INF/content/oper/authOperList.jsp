...
function submitForm(url, act)
{
    ...
    if(act == "modify"){
		...
		$.ajax({
			...
			url:url,
			dateType:"json",
			data:'operatorNos='+ idstr,
			success: function(msg){
// 				alert(msg);
			},
			error: function(msg){
				//alert("操作员审核失败,请与管理员联系！");
			}
		});
								...
								<table width="100%" border="0">
									<tr>
										...
										<td >
											...
											<a href="javascript:submitForm('<%=path%>/acegi/queryByOperStatus.do','search')">
						...
						<div class="headPageNavi">
							...
							<div style="float: left;" class="tools">
								<ul>
									...
									<li style="width: 85px">
										<a href="javascript:gotoListHome()" onclick="submitForm('<%=path%>/acegi/auditOperator.do','modify')"><img
